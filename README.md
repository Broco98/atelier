...
[Releases](https://github.com/Broco98/atelier/releases)에서 다운로드. macOS Apple Silicon 전용.
...
main에서 버전을 올리고 태그를 push하면 GitHub Actions가 dmg와 CLI tar.gz를 빌드해 릴리스를 자동 publish합니다.
