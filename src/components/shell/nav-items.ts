import { Archive, Folder, Terminal, type LucideIcon } from "lucide-react";
...
//
// Sessions는 그 "한 줄"의 첫 사례다 — 세션은 Work에 딸린 부속물이 아니라 독립된 것이라
// 최상위에 둔다. 아래 작업 목록이 "지금 하는 일"이므로 그와 가까운 자리에 붙인다.
//
...
export const navItems = [
  ...
  { key: "sessions", label: "Sessions", icon: Terminal, to: "/sessions" },
