// 앱 규격으로 고친 자리: registry의 svg 하나를 다시 짰다(결정 5) — 겉 상자 span이 data-slot·role·aria-label을 들고, 안에 호(Loader2Icon)와 원(CircleIcon)을 둬 동작 줄이기면 motion-reduce 변형이 호를 숨기고 원을 세운다.
...
// role="status"와 영어 이름 「Loading」이 남는다.
//
