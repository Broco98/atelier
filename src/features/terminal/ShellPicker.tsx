 ...
 *
 * **입구는 둘인데 메뉴는 하나다** — 가로 탭 줄(`ShellTabs`)과 패널 목록(`ShellList`)이
 * 같은 것을 연다. 여는 버튼은 서로 아주 달라서(폭 없는 아이콘 하나 vs 글자 있는 행) 각자
 * 두고, **열리는 것만** 여기 모은다. 둘로 두면 규격이 조용히 갈린다.
 *
 * 셸도 xterm도 여기 없다 — 부르는 두 파일과 같은 성질이라 DOM 없는 기본 환경에서 그대로
 * 검사된다.
 */
